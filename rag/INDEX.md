...
- [Codex app-server Observer runtime契約](codex-app-server/runtime-contract.md) — thread／turnのcwd・read-only・persistent handle・interrupt terminal・AGENTS.md読込を0.144.3公式資料とschemaから固定（2026-07-15、確度: official-primary / local-schema-verified）
